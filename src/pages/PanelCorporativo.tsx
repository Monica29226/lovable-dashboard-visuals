...
export default function PanelCorporativo() {
  ...
  const t = {
    es: {
      title: 'Panel Corporativo', subtitle: 'Vista consolidada de todas las empresas',
    ...
    en: {
      title: 'Corporate Panel', subtitle: 'Consolidated view of all companies',
  ...
  return (
    <div className="p-6">
      <div className="max-w-[1400px] mx-auto space-y-6">
        <div>
          <h1 className="font-display text-3xl text-foreground mb-1">{t.title}</h1>
